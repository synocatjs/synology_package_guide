...
**PUT** `/api/Calendar/default/v1/cal`
...
```json
{
    ...
    "cal_displayname": "My Personal Calendar",
    "cal_description": "Personal calendar for events and tasks",
    "cal_color": "#EA4335",
...
```bash
curl -X PUT "https://{nas_url}/api/Calendar/default/v1/cal" \
  -H "accept: application/json" \
  -H "content-type: application/json" \
  -H "cookie: id={sid}" \
  -d '{"cal_id":"/admin/home/","original_cal_id":"/admin/home/","cal_displayname":"My Personal Calendar","cal_description":"Personal calendar for events and tasks","cal_color":"#EA4335","is_hidden_in_cal":false,"is_hidden_in_list":false,"notify_alarm_by_browser":true,"notify_alarm_by_mail":true,"notify_evt_by_browser":true,"notify_evt_by_mail":true,"notify_import_cal_by_browser":true,"notify_import_cal_by_mail":false}'
```
...
响应结构与 [获取日历信息] 接口返回的 data 对象一致，返回更新后的日历信息。

| 字段 | 类型 | 描述 |
|------|------|------|
| `success` | boolean | 表示请求是否成功 |
| `error.code` | integer | 错误代码（仅在请求失败时返回） |
| `data` | object | 更新后的日历信息 |
